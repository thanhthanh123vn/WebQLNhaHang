            ...
            <div class="footer-col footer-col-1 col">
                <div class="footer-col-content footer-info">
                    ...
                    <p class="footer-info__address">
                        Khu Phố 6 , phường Linh Trung, Thành PhốPhố Thủ Đức, TP.Hồ Chí Minh
                    </p>
                    <p class="footer-info__phone">(+84-4) 352.169.819</p>
                    <p class="footer-info__email">nguyenthanh556556@gmail.com</p>
            ...
            <div class="footer-col footer-col-4 col">
                <div class="fanpage-facebook">
                    ...
                    <div class="fanpage-facebook-content">
                        <a href="http://www.facebook.com/" class="fanpage-facebook-name">NHÀ HÀNG NH&SK</a>
    ...
    <div class="container footer--bottom">
        <div class="row">
            <div class="col col-sm-12 col-md-7">
                <div class="footer-copyright">COPYRIGHT © 2022 BY NH&SKSK</div>
                <ul class="menu-footer">
                    <li class="menu-footer__link">
