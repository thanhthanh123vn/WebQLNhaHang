...
<html lang="vi">
  <head>
    ...
    <link rel="stylesheet" href="../../css/admin-control-page.css">
  </head>
  ...
  <body>
          ...
          <div class="container">
            <div class="row">
              <div class="header-logo header-main--top col-lg-12">
                ...
                <div class="menu_box">
                  <a href="/" class="logo">
                    <img srcset="../../images/logo-webweb.png" alt="logo" />
                  </a>
                  <p class="menu_name">
                    Thêm mới đơn đặt bàn
                  </p>
                </div>
              </div>
                ...
                <div class="px-4 header-nav">
                  <ul class="menu">
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-home-page.html" class="menu-link">Bảng thống kê</a>
                    </li>
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-account-page.html" class="menu-link">Tài khoản</a>
                    </li>
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-menu-page.html" class="menu-link">Thực đơn</a>
                    </li>
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-food-page.html" class="menu-link">Đồ ăn</a>
                    </li>
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-drink-page.html" class="menu-link">Đồ uống</a>
                    </li>
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-news-page.html" class="menu-link">Tin tức</a>
                    </li>
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-photo-library.html" class="menu-link">Thư viện ảnh</a>
                    </li>
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-booking-page.html" class="menu-link">Đặt bàn</a>
                    </li>
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-evaluate-page.html" class="menu-link">Đánh giá</a>
                    </li>
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-order-page.html" class="menu-link">Đặt món</a>
                    </li>
                    <li class="menu-item active">
                      <a href="../admin-control/admin-control-vourcher-page.html" class="menu-link">Vourcher</a>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="content">
            <form action="" method="post" class="form__add">
              ...
              <div class="form_add__name">
                <label class="form_text" for="mail">Mail</label> <br>
                <input class="form_add__input" type="text" name="mail" placeholder="Aa">
              </div>
      
              <div class="form_add__name">
                <label class="form_text" for="mail">SDT</label> <br>
                <input class="form_add__input" type="text" name="mail" placeholder="Aa">
              </div>
      
              <div class="form_add__name">
                <label class="form_text" for="pass">Trạng thái</label> <br>
                <input class="form_add__input" type="text" name="pass" placeholder="Aa">
              </div>
              ...
              <div class="form_add__name">
                <label class="form_text" for="mail">Số khách</label> <br>
                <input class="form_add__input" type="text" name="mail" placeholder="Aa">
              </div>
      
              <div class="form_add__name">
                <label class="form_text" for="mail">Cơ sở</label> <br>
                <input class="form_add__input" type="text" name="mail" placeholder="Aa">
              </div>
          ...
          <div class="row">
            <div class="footer-col footer-col-1 col">
              <div class="footer-col-content footer-info">
                <a href="../../home-page.html" class="footer-logo"
                ...
                <p class="footer-info__phone">(+84-4)352.169.819819 </p>
            ...
            <div class="footer-col footer-col-4 col">
              <div class="fanpage-facebook">
                ...
                <div class="fanpage-facebook-content">
                  <a href="../../http://www.facebook.com/" class="fanpage-facebook-name">NHÀ HÀNG NH&SKSK</a>
    ...
    <script type="text/javascript" src="../../js/get-img.js"></script>
  </body>
</html>
